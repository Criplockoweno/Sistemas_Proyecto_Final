...
public enum ManejadorSubastas {
    ...
    public synchronized int subscribeToSubastaSession(String id_Client, Integer id_Subasta_Session) {
        ...
        // if a client isnt subscribed to a subasta, he cant subscribe to a subasta
        // session
    ...
    public synchronized int unsubscribeToSubastaSession(String id_Client, Integer id_Subasta_Session) {
        ...
        for (Subasta subasta : subastaSessions.get(id_Subasta_Session).getSubastas()) {
            subasta.removeClient(id_Client);
            suscribers.get(id_Client).unsubscribeToSubasta(subasta.getId());
        }
